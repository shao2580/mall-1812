...
<html class="x-admin-sm">
    <head>
        ...
        <!-- <link rel="stylesheet" href="{{url('admin')}}/css/theme5.css"> -->
    ...
    <body class="index">
        ...
        <div class="container">
            <div class="logo">
                <a href="{{url('admin')}}/index.html">X-admin v2.2</a></div>
            <div class="left_open">
            ...
            <ul class="layui-nav right" lay-filter="">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="{{url('admin')}}/login.html">退出</a></dd>
                    </dl>
                </li>
            ...
            <div id="side-nav">
                <ul id="nav">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('分类添加','{{url('category/create')}}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>分类添加</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('分类列表','{{url('category/list')}}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>分类列表</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('品牌添加','{{url('fenlan/add')}}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>品牌添加</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('品牌删除','{{url('fenlan/lists')}}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>品牌列表</cite></a>
                            </li>
                        </ul>
