						...
						<div class="pop">
							<div class="left fl">
								...
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{asset('index/image/5c_80.png')}}" alt=""></div>
								...
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{asset('index/image/xmNOTE2-80.jpg')}}" alt=""></div>
								...
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{asset('index/image/MIX-80.jpg')}}" alt=""></div>
								...
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{asset('/index/image/xm5Splus.jpg')}}" alt=""></div>
							...
							<div class="ctn fl">
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{asset('/index/image/xm5-80.jpg')}}" alt=""></div>
								...
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{asset('/index/image/hmn4x80.png')}}" alt=""></div>
								...
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{asset('/index/image/hmnote4-80.jpg')}}" alt=""></div>
								...
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{asset('/index/image/hm4x_80.png')}}" alt=""></div>
								...
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{asset('/index/image/hm4-80.jpg')}}" alt=""></div>
								...
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{asset('/index/image/hm4A-80.jpg')}}" alt=""></div>
		...
		<div class="danpin center">
			...
			<div class="main center">
				<div class="mingxing fl">
					<div class="sub_mingxing"><a href="{{url('/index/goods')}}"><img src="./image/pinpai1.png" alt=""></a></div>
					<div class="pinpai"><a href="{{url('/index/goods')}}">小米MIX</a></div>
